...
namespace CakeMVC.Context
{
    ...
    public class CakesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CakeId,Flavor,Cover,Description,Price")] Cake cake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CakeId,Flavor,Cover,Description,Price")] Cake cake)
        {
            if (id != cake.CakeId)
            {
                return NotFound();
